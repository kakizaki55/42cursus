...
/*   Updated: 2025/01/13 17:43:07 by mkakizak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_forks *node = ft_calloc(sizeof(t_forks), 1);
	if (node == NULL)
		return NULL;
...
{
	t_forks *new_node = create_fork_node(fork_number);
	if (new_node == NULL)
		return NULL;
...
{
	t_forks *head = create_fork_node(0);
	if (head == NULL)
	{
