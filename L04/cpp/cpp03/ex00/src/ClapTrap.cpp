...
ClapTrap::ClapTrap()
	: _name("Default"), _hit_points(10), _max_hit_points(10), _engery_points(10), _attack_damage(0)
	{
		std::cout << "Default constructor called:" << _name << " created." << std::endl;
	}

ClapTrap::ClapTrap(std::string name)
	: _name(name), _hit_points(10), _max_hit_points(10), _engery_points(10), _attack_damage(0)
	{
		std::cout << "Parameterized constructor called: " << _name << " created." << std::endl;
	}

ClapTrap::ClapTrap(const ClapTrap &other)
	: _name(other._name), _hit_points(other._hit_points), _max_hit_points(other._max_hit_points),
