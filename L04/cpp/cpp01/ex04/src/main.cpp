...
int main(int argc, char** argv)
{
    ...
    if(file_name.empty() || str1.empty())
    {
        std::cerr << "Error: you must have a file name and string to find." << std::endl;
        return 1;
    }
    ...
    if (str1 == str2)
    {
        std::cerr << "Error: you cant replace the string with the same string"<< std:: endl;
        return 1;
    }
